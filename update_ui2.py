...
# 1. Swap the div order
old_divs = """      <div class="chart-box full-width" id="bubble-chart-container"></div>
      <div class="chart-box full-width" id="network-chart-container" style="height: 700px; margin-top: 20px;"></div>"""
new_divs = """      <div class="chart-box full-width" id="network-chart-container" style="height: 750px; position: relative;"></div>
...
# 2. Modify initNetworkChart
# Use regex to find and replace the initNetworkChart block
...
if network_func_match:
  ...
  centerBtn.onclick = () => myChart.dispatchAction({ type: 'restore' });
...
print('Updated Network Chart successfully!')
